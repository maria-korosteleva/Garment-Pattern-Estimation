...
def get_values_from_args():
    ...
    parser.add_argument('--mesh_samples', '-m', help='number of samples per mesh ', type=int, default=5000)
    ...
    parser.add_argument('--r1', '-r1', help='size of second PN++ layer radius', type=float, default=2)
    parser.add_argument('--r2', '-r2', help='size of first PN++ layer radius', type=float, default=7)
...
def get_data_config(in_config, old_stats=False):
    ...
    if old_stats:
        ...
        old_experiment = WandbRunWrappper(system_info['wandb_username'],
            ...
            run_name='Pattern3D-mean', run_id='3hd85b5s'
        )
