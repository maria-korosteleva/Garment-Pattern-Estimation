...
dataset = data.GarmentPanelDataset(Path(system_info['datasets_path']) / dataset_folder, {'panel_name': 'front'})
...
model = nets.GarmentPanelsAE(
    ...
    {'hidden_dim_enc': 15, 'hidden_dim_dec': 15, 'n_layers': 4, 'loop_loss_weight': 0.1})
